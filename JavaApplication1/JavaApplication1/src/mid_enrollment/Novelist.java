...
public class Novelist extends bookAuthor{
    private String pName, wStyle;
    private double rating;

    public Novelist(String pName, String wStyle, double rating, String aName, String aGender, String aContact, String aEmail, String aWebsite) {
